...
Acsse https://danhamash.github.io/Landding-page-/

O destaque do projeto é o **sistema de troca de cores (Theme Switcher)**, que permite ao usuário alterar dinamicamente a identidade visual da página — incluindo **título principal** e **botões de ação** — através de botões interativos.

## Design
O design visual do projeto foi criado do zero, desde a concepção até a implementação final.
...
- CSS3
- JavaScript (Vanilla)
- Tailwind CSS (utilitários e layout)
- SVG Inline
